---
name: Develop in Kubernetes (with Open in Coder)
...
This template creates a pod using a custom image, and can auto-clone a git repository, if specified. Try with the following values:

- Git repository: `https://github.com/bcdr-demos/v2-blog`
- Image: `mcr.microsoft.com/vscode/devcontainers/javascript-node:16-bullseye`

This also requires you have a [Git provider](http://localhost:3000/docs/v2/latest/admin/git-providers) named `github` in your deployment.

> Learn more about [Open in Coder](https://coder.com/docs/v2/latest/templates/open-in-coder)
